...
function draw() {
  ...
  background(255)
  textSize(100)
  text(a + b + c + d + e + f + g + h + ' Wins', 75, 100)
  fill(0)
  ...
  background(255)
  textSize(100)
  text(i + j + k + l + m + n + o + p + ' Wins', 75, 100)
  fill(0)
  rect(450, 650, 300, 100)
  ...
  if(Mode == 5) {
    ...
    fill(255)
    textSize(35)
    text('Nanny vs Papa', 57, 160)
    
    fill(0)
    rect(500, 100, 250, 100)
    fill(255)
    textSize(35)
    text(' Nanny vs Ben', 507, 160)
    
    fill(0)
    rect(50, 250, 250, 100)
    fill(255)
    textSize(32)
    text('Nanny vs James', 57, 310)
    
    fill(0)
    rect(500, 250, 250, 100)
    fill(255)
    textSize(36)
    text('Nanny vs Mom', 507, 310)
    
    fill(0)
    rect(50, 400, 250, 100)
    fill(255)
    textSize(35)
    text(' Nanny vs Dad', 57, 460)
